...
This script performs a complete integration test of all modules
...
def main():
    """Run all tests."""
    print_header("Polymarket Trading Bot - Full Integration Test")
    ...
    if not creds["safe_address"]:
        print_error("POLY_SAFE_ADDRESS environment variable not set!")
        print_info("Set it with: export POLY_SAFE_ADDRESS=0x...")
        sys.exit(1)
